...
This project is indexed by GitNexus as **aem-mcp-server** (1119 symbols, 1926 relationships, 98 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/aem-mcp-server/context` | Codebase overview, check index freshness |
| `gitnexus://repo/aem-mcp-server/clusters` | All functional areas |
| `gitnexus://repo/aem-mcp-server/processes` | All execution flows |
| `gitnexus://repo/aem-mcp-server/process/{name}` | Step-by-step execution trace |
